...
public class ApplicationRetrofitServices {
    ...
    public LiveStreamService getLiveStreamService() {
        return RetrofitClient.getInstance().getRetrofit().create(LiveStreamService.class);
    }
    ...
    public IStoreDataSource getStoreService(){
        return RetrofitClient.getInstance().getRetrofit().create(IStoreDataSource.class);
    }

    public IAddressDataSource getAddressService(){
        return RetrofitClient.getInstance().getRetrofit().create(IAddressDataSource.class);
    }
}
