...
import com.app.swagliv.view.activities.ShoppingCartActivity;
import com.app.swagliv.view.activities.StoreActivity;
...
public class HomeFragment extends Fragment implements CardStackListener, View.OnClickListener, APIResponseHandler, MatchedProfileDialog.OnMatchButtonClickListener {
    ...
    private void initialize() {
        ...
        mBinding.drawerIconForStore.setOnClickListener(this);
        //--------------
