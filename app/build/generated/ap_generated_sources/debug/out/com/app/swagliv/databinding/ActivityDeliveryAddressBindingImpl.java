...
public class ActivityDeliveryAddressBindingImpl extends ActivityDeliveryAddressBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_add_new_address, 2);
        sViewsWithIds.put(R.id.recyclerview_address, 3);
        sViewsWithIds.put(R.id.btn_proceed, 4);
    }
    // views
    @NonNull
    ...
    public ActivityDeliveryAddressBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityDeliveryAddressBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
