...
public class ActivityManageConnectionBindingImpl extends ActivityManageConnectionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.connection_Recycle_view, 2);
        sViewsWithIds.put(R.id.bt_add, 3);
    }
    // views
    @NonNull
    ...
    public ActivityManageConnectionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivityManageConnectionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
