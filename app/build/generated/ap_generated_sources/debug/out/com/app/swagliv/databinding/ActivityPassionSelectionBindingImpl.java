...
public class ActivityPassionSelectionBindingImpl extends ActivityPassionSelectionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.passion_text_layout, 2);
        sViewsWithIds.put(R.id.passion_chips_recycle, 3);
        sViewsWithIds.put(R.id.passion_btn_continue, 4);
        sViewsWithIds.put(R.id.number_count, 5);
    }
    // views
    @NonNull
    ...
    public ActivityPassionSelectionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityPassionSelectionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.app.swagliv.databinding.CommonHeaderBinding) bindings[1]
            , (android.widget.TextView) bindings[5]
            , (android.widget.RelativeLayout) bindings[4]
            , (com.app.chiprecycleview.MultiChipsRecyclerView) bindings[3]
