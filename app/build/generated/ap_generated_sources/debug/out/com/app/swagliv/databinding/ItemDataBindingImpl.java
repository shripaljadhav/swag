...
public class ItemDataBindingImpl extends ItemDataBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.passion == variableId) {
            setPassion((com.app.swagliv.model.home.pojo.Passions) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPassion(@Nullable com.app.swagliv.model.home.pojo.Passions Passion) {
