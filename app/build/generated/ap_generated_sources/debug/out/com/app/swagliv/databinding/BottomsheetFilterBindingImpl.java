...
public class BottomsheetFilterBindingImpl extends BottomsheetFilterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textview_category, 1);
        sViewsWithIds.put(R.id.recyclerview_category, 2);
        sViewsWithIds.put(R.id.textview_sub_category, 3);
        sViewsWithIds.put(R.id.recyclerview_sub_category, 4);
        sViewsWithIds.put(R.id.textview_coins, 5);
        sViewsWithIds.put(R.id.coin_range, 6);
    ...
    private BottomsheetFilterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.google.android.material.slider.RangeSlider) bindings[6]
