...
public class ActivityIntroBindingImpl extends ActivityIntroBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.view_pager2, 1);
        sViewsWithIds.put(R.id.wormDotsIndicator, 2);
        sViewsWithIds.put(R.id.skip_button, 3);
        sViewsWithIds.put(R.id.nextBtn, 4);
    }
    // views
    // variables
    // values
    ...
    private ActivityIntroBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.parentLayoutViewpager.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
