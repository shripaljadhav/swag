...
public final class ItemSubCategoryBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout layoutSubCategory;

  @NonNull
  public final TextView textviewCategory;

  private ItemSubCategoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout layoutSubCategory, @NonNull TextView textviewCategory) {
    this.rootView = rootView;
    this.layoutSubCategory = layoutSubCategory;
  ...
  public static ItemSubCategoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout layoutSubCategory = (ConstraintLayout) rootView;
      ...
      return new ItemSubCategoryBinding((ConstraintLayout) rootView, layoutSubCategory,
          textviewCategory);
    }
