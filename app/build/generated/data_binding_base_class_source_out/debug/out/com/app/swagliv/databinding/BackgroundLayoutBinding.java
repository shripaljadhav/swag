...
public final class BackgroundLayoutBinding implements ViewBinding {
  ...
  private BackgroundLayoutBinding(@NonNull LinearLayout rootView) {
  ...
  public static BackgroundLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.background_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static BackgroundLayoutBinding bind(@NonNull View rootView) {
    ...
    return new BackgroundLayoutBinding((LinearLayout) rootView);
  }
}
