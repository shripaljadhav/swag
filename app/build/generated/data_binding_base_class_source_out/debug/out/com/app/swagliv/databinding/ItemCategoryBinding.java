...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout layoutCategory, @NonNull TextView textviewCategory) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout layoutCategory = (ConstraintLayout) rootView;
      ...
      return new ItemCategoryBinding((ConstraintLayout) rootView, layoutCategory, textviewCategory);
    }
