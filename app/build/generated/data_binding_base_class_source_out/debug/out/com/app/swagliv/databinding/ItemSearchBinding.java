...
public abstract class ItemSearchBinding extends ViewDataBinding {
  @NonNull
  public final TextView crushAge;

  @NonNull
  public final TextView crushGender;

  @NonNull
  public final TextView crushName;

  @NonNull
  public final LinearLayout parentLayout;

  @NonNull
  public final ShapeableImageView pictures;

  @Bindable
  protected User mCrushInfo;

  protected ItemSearchBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TextView crushAge, TextView crushGender, TextView crushName, LinearLayout parentLayout,
      ShapeableImageView pictures) {
    super(_bindingComponent, _root, _localFieldCount);
    this.crushAge = crushAge;
    this.crushGender = crushGender;
    this.crushName = crushName;
    this.parentLayout = parentLayout;
    this.pictures = pictures;
  }

  public abstract void setCrushInfo(@Nullable User crushInfo);

  @Nullable
  public User getCrushInfo() {
    return mCrushInfo;
  }
